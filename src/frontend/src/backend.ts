...
export class Backend implements backendInterface {
    ...
    async submitBookingInquiry(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitTestimonial(arg0: string, arg1: bigint, arg2: string): Promise<void> {
        if (this.processError) {
            try {
